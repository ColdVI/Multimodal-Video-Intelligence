...
- `tests/` altindaki 46 testin tamami (`scripts/poc.ps1 test` / `pytest`) -
  ...
  sonradan eklendi; guncel sonuc 46/46. Detay:
  [docs/architecture/CURRENT_SYSTEM.md](../architecture/CURRENT_SYSTEM.md) ve
  [docs/operations/STATUS.md](../operations/STATUS.md).
...
- Resmî VisDrone-MOT trainseti indirildi ve 56/56/24.201 veri sözleşmesi
  ...
  GT/eval hattından geçti; ayrıntılar
  [docs/operations/STATUS.md](../operations/STATUS.md) dosyasında.
...
- `models/siglip_avg.py` — gerçek SigLIP2 sonucu için
  [docs/operations/STATUS.md](../operations/STATUS.md) geçerlidir.
...
[`docs/agents/TASKS.md`](TASKS.md)'deki checklist'i sırayla işle. Her fazın sonunda Windows'ta
